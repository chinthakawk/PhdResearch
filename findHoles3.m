...
fol = '/Users/mac/Documents/NCU/Research/Progress Presentations/20160321_RGBDvsPC/02_RgbF1/K1/15_findNFillSmallHoles_20160429/';
name = '1_1545057_rgbd_oo_refined_nR_oP=0.15_pDs=7_pD=6.6753_sr_dis=0.001_np=8.mat';
...
names = {'angle' 'boundary' 'g' 'halfdisk' 'miup' 'nei' 'neic' 'neid'...
    'normal' 'piboundary' 'picorner' 'piinterior' 'piline' 'prob'};

for i = 1:numel(names)
    save(strcat(fol,name,'_',names{i},'.mat'), names{i});
end
