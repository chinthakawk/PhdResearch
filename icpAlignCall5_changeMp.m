...
fol = '/Users/mac/Documents/KinectData/Lab2/20160121/02_littleCloser/0122/07_oOrefined_dBnR_movedToOrigin_manualRoughAlignICP/1t2/';
nameR = '2.mat';
nameS = '1.mat';
mP = [0.25 0.5 0.75 .9 0.99 1]; % merge percentage
...
for i = 1:numel(mP)
    fmergeBasedOnPercentage(pc1, data2r', corr, mP(i), fileID, fol, result);
end
