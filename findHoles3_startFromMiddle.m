...
% clc, clear all;
% 
% fol = '/Users/mac/Documents/NCU/Research/Progress Presentations/20160321_RGBDvsPC/02_RgbF1/K1/13_findHolesWithAllCriteria_20160425/';
...
for i = 1:numel(names)
    save(strcat(fol,names{i},'.mat'), names{i});
end
